...
<div class="app-modal" data-name="settings">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="settings" data-modal='0'>
            @php
                // Use guest session if user is not logged in
            ...
            <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="app-modal-body">
                    ...
                    <div class="avatar av-l upload-avatar-preview chatify-d-flex"
                        style="background-image: url('{{ $chatUser->avatar ?? 'https://via.placeholder.com/150' }}');">
                    </div>
                    <p class="upload-avatar-details"></p>
                    <label class="app-btn a-btn-primary update" style="background-color: {{ $messengerColor ?? '#3498db' }}">
                        Upload New
                    ...
                    <p class="app-modal-header">Dark Mode
                        <span class="{{ $chatUser->dark_mode ?? 0 > 0 ? 'fas' : 'far' }} fa-moon dark-mode-switch"
                              data-mode="{{ $chatUser->dark_mode ?? 0 }}"></span>
                    </p>
